...
*      APPEND INITIAL LINE TO lt_textpool ASSIGNING <ls_textpool>.
    ...
    TRY.                                                                                                               ">=SAPBASIS700
      ...
      CATCH cx_root.  "e.g. CX_SY_DYN_CALL_ILLEGAL_FUNC                                                                 ">=SAPBASIS700
        MESSAGE x666(01) WITH 'Error in function RPY_TEXTELEMENTS_INSERT.' 'Check Note 1842889' INTO sy-lisel. "#EC *   ">=SAPBASIS700
...
FORM update_01. " REPT ZEWM_INBOUND_STEP1 ( EN , source: EW1 )
  CALL METHOD lcl_wb=>create_program_text    "#EC *
    EXPORTING
      i_progname  = 'ZEWM_INBOUND_STEP1'
      i_devclass  = '$TMP'
      i_langu     = 'E':
      i_id        = 'R'
      i_key       = ''
      i_text      = 'Inbound Process Step 1 (Pack & Goods Receipts)'  "#EC NOTEXT
      i_length    = '46',
...
FORM update_02. " REPT ZEWM_INBOUND_STEP1 ( JA , source: EW1 )
  CALL METHOD lcl_wb=>create_program_text    "#EC *
    EXPORTING
      i_progname  = 'ZEWM_INBOUND_STEP1'
      i_devclass  = '$TMP'
      ...
      i_id        = 'R'
      i_key       = ''
      i_text      = '入荷プロセス ステップ1 (梱包及び入庫）'  "#EC NOTEXT
      i_length    = '70',
...
FORM update_03. " REPT ZEWM_INBOUND_STEP2_IO ( EN , source: EW1 )
  CALL METHOD lcl_wb=>create_program_text    "#EC *
    EXPORTING
      i_progname  = 'ZEWM_INBOUND_STEP2_IO'
      i_devclass  = '$TMP'
      i_langu     = 'E':
      i_id        = 'R'
      i_key       = ''
      i_text      = 'Inbound Process Step 2(Putaway + Move HU to Out Section)'  "#EC NOTEXT
      i_length    = '56',
...
FORM update_04. " REPT ZEWM_INBOUND_STEP2_IO ( JA , source: EW1 )
  CALL METHOD lcl_wb=>create_program_text    "#EC *
    EXPORTING
      i_progname  = 'ZEWM_INBOUND_STEP2_IO'
      i_devclass  = '$TMP'
      ...
      i_id        = 'R'
      i_key       = ''
      i_text      = '入荷プロセス ステップ2 (在庫受入、入荷ステーションでの倉庫タスク登録）'  "#EC NOTEXT
      i_length    = '70',
...
FORM update_05. " REPT ZEWM_INOUT_SETUP ( EN , source: EW1 )
  CALL METHOD lcl_wb=>create_program_text    "#EC *
    EXPORTING
      i_progname  = 'ZEWM_INOUT_SETUP'
      i_devclass  = '$TMP'
      i_langu     = 'E':
      i_id        = 'R'
      i_key       = ''
      i_text      = 'Trigger ERP for outbound delivery creation (Update addon table in EWM)'  "#EC NOTEXT
      i_length    = '70',

      i_id        = 'S'
      i_key       = 'P_DOCNO'
      i_text      = 'Inbound Delivery Document'  "#EC NOTEXT
      i_length    = '33',
      ...
      i_id        = 'S'
      i_key       = 'P_PO'
      i_text      = 'Purchase order number (ERP)'  "#EC NOTEXT
      i_length    = '35',

      i_id        = 'S'
      i_key       = 'P_SO'
      i_text      = 'Sales order number (ERP)'  "#EC NOTEXT
      i_length    = '32'.

ENDFORM.

FORM update_06. " REPT ZEWM_INOUT_SETUP ( JA , source: EW1 )
  CALL METHOD lcl_wb=>create_program_text    "#EC *
    EXPORTING
      i_progname  = 'ZEWM_INOUT_SETUP'
      i_devclass  = '$TMP'
      ...
      i_id        = 'R'
      i_key       = ''
      i_text      = '入荷即出荷制御用アドオンテーブル登録/ERPへ出荷伝票登録（未実装）'  "#EC NOTEXT
      i_length    = '70',

      i_id        = 'S'
      i_key       = 'P_DOCNO'
      i_text      = '入荷伝票'  "#EC NOTEXT
      i_length    = '33',
      ...
      i_id        = 'S'
      i_key       = 'P_PO'
      i_text      = '発注伝票番号（ERP)'  "#EC NOTEXT
      i_length    = '35',

      i_id        = 'S'
      i_key       = 'P_SO'
      i_text      = '受注伝票番号（ERP)'  "#EC NOTEXT
      i_length    = '32'.
...
FORM update.
  ...
  PERFORM update_01. " REPT ZEWM_INBOUND_STEP1 ( EN , source: EW1 )
  PERFORM update_02. " REPT ZEWM_INBOUND_STEP1 ( JA , source: EW1 )
  PERFORM update_03. " REPT ZEWM_INBOUND_STEP2_IO ( EN , source: EW1 )
  PERFORM update_04. " REPT ZEWM_INBOUND_STEP2_IO ( JA , source: EW1 )
  PERFORM update_05. " REPT ZEWM_INOUT_SETUP ( EN , source: EW1 )
  PERFORM update_06. " REPT ZEWM_INOUT_SETUP ( JA , source: EW1 )
