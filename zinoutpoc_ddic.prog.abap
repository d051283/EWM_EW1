REPORT ZINOUTPOC_DDIC.

* Generated by SAP_LOCAL_DOWNPORT_ASSISTANT Version 6.05 on 14.04.2017 with option ALL

* The individual coding starts at 'FORM update_01.' ( line 3.801 )
...
CLASS lcl_wb IMPLEMENTATION.
  ...
  METHOD init.
    ...
    CONCATENATE 'AOBJ''CHDO''IWPR''IWMO''IWSV''SUCD''SUSC''SUSK''DIOB''DTRF''DROU'
                ...
                'CFDO''CFDS''CFDT''FSEL''DMEE''SBDL''SBDP'
...
FORM update_01. " DOMD ZEWM_DO_CTRL_STATUS ( EN , source: EW1 )
  CALL METHOD lcl_wb=>create_doma   "#EC *
    EXPORTING
      i_domname    = 'ZEWM_DO_CTRL_STATUS'
      i_devclass   = '$TMP'
      i_datatype   = 'CHAR'
      i_langu      = 'E'
      i_ddtext     = 'Status'
      ...
      i_domvalue   = ''
      i_valpos     = '0001'
      i_valtext    = 'Unprocessed',                                                                                "#EC NOTEXT
      i_domvalue   = '1'
      i_valpos     = '0002'
      i_valtext    = 'Inbound process: complete',                                                                  "#EC NOTEXT
      i_domvalue   = '2'
      i_valpos     = '0003'
      i_valtext    = 'Outbound process: wave assignment complete',                                                 "#EC NOTEXT
      i_domvalue   = '3'
      i_valpos     = '0004'
      i_valtext    = 'Outbound process: warehouse task complete'                                                   "#EC NOTEXT
      .

ENDFORM.

FORM update_02. " DOMD ZEWM_DO_CTRL_STATUS ( JA , source: EW1 )
  CALL METHOD lcl_wb=>create_doma   "#EC *
    EXPORTING
      i_domname    = 'ZEWM_DO_CTRL_STATUS'
      i_devclass   = '$TMP'
      ...
      i_domvalue   = ''
      i_valpos     = '0001'
      i_valtext    = '未処理',                                                                                        "#EC NOTEXT
      i_domvalue   = '1'
      i_valpos     = '0002'
      i_valtext    = '入荷処理完了',                                                                                     "#EC NOTEXT
      i_domvalue   = '2'
      i_valpos     = '0003'
      i_valtext    = '出荷処理 - ウェーブ割当完了',                                                                            "#EC NOTEXT
      i_domvalue   = '3'
      i_valpos     = '0004'
      i_valtext    = '出荷処理 - ウェーブリリース完了(倉庫タスク登録完了）'                                                                "#EC NOTEXT
      .

ENDFORM.

FORM update_03. " DTED ZEWM_DE_CTRL_STATUS ( EN , source: EW1 )
  CALL METHOD lcl_wb=>create_dtel    "#EC *
    EXPORTING
      i_rollname  = 'ZEWM_DE_CTRL_STATUS'
      i_devclass  = '$TMP'
      i_domname   = 'ZEWM_DO_CTRL_STATUS'
      i_headlen   = '00'
      i_scrlen1   = '10'
...
FORM update_04. " DTED ZEWM_DE_CTRL_STATUS ( JA , source: EW1 )
  CALL METHOD lcl_wb=>create_dtel    "#EC *
    EXPORTING
      i_rollname  = 'ZEWM_DE_CTRL_STATUS'
      i_devclass  = '$TMP'
...
FORM update_05. " TABD ZEWMINOUTCTRL ( EN , source: EW1 )
  ...
  CALL METHOD lcl_wb=>create_table     "#EC *
    EXPORTING
      ...
      i_roworcolst = 'C'
      i_langu      = 'E'
      i_ddtext     = 'Inbound/Outbound control table'.
  ...
  CALL METHOD lcl_wb=>add_field_to_table    "#EC *
    EXPORTING
      i_tabname   = 'ZEWMINOUTCTRL'
      i_fieldname = 'PDI_DOCNO'
      i_rollname  = '/SCDL/DL_DOCNO_INT'
      i_context   = 'MATID'.
  ...
  CALL METHOD lcl_wb=>add_field_to_table    "#EC *
    EXPORTING
      i_tabname   = 'ZEWMINOUTCTRL'
      i_fieldname = 'PDI_ITMNO'
      i_rollname  = '/SCDL/DL_ITEMNO'
      i_context   = 'PDI_DOCNO'.
  ...
  CALL METHOD lcl_wb=>add_field_to_table    "#EC *
    EXPORTING
      i_tabname   = 'ZEWMINOUTCTRL'
      i_fieldname = 'PDI_DOCID'
      i_rollname  = '/SCDL/DL_DOCID'
      i_context   = 'PDI_ITMNO'.
  ...
  CALL METHOD lcl_wb=>add_field_to_table    "#EC *
    EXPORTING
      i_tabname   = 'ZEWMINOUTCTRL'
      i_fieldname = 'PDI_ITMID'
      i_rollname  = '/SCDL/DL_ITEMID'
      i_context   = 'PDI_DOCID'.
  ...
  CALL METHOD lcl_wb=>add_field_to_table    "#EC *
    EXPORTING
      i_tabname   = 'ZEWMINOUTCTRL'
      i_fieldname = 'WAVE_ITM'
      i_rollname  = '/SCWM/DE_WAVE_ITM'
      i_context   = 'WAVE'.
  ...
  CALL METHOD lcl_wb=>add_field_to_table    "#EC *
    EXPORTING
      i_tabname   = 'ZEWMINOUTCTRL'
      i_fieldname = 'SPLIT_ID'
      i_rollname  = '/SCWM/DL_SPLIT_ID'
      i_context   = 'WAVE_ITM'.
  ...
  CALL METHOD lcl_wb=>add_field_to_table    "#EC *
    EXPORTING
      i_tabname   = 'ZEWMINOUTCTRL'
      i_fieldname = 'CREATE_TS'
      i_rollname  = 'TZNTSTMPS'
      i_context   = 'STATUS'.
  ...
  CALL METHOD lcl_wb=>add_field_to_table    "#EC *
    EXPORTING
      i_tabname   = 'ZEWMINOUTCTRL'
      i_fieldname = 'NLPLA'
      i_rollname  = '/SCWM/LTAP_NLPLA'
      i_context   = 'NLBER'.

ENDFORM.

FORM update_06. " TABD ZEWMINOUTCTRL ( JA , source: EW1 )
...
FORM update_07. " TABT ZEWMINOUTCTRL ( EN , source: EW1 )
...
FORM update.
  ...
  APPEND 'ZEWMINOUTCTRL'                          TO gt_tabname.   "#EC NOTEXT
  APPEND 'ZEWMINOUTCTRL'                          TO gt_tabname.   "#EC NOTEXT

  PERFORM update_01. " DOMD ZEWM_DO_CTRL_STATUS ( EN , source: EW1 )
  PERFORM update_02. " DOMD ZEWM_DO_CTRL_STATUS ( JA , source: EW1 )
  PERFORM update_03. " DTED ZEWM_DE_CTRL_STATUS ( EN , source: EW1 )
  PERFORM update_04. " DTED ZEWM_DE_CTRL_STATUS ( JA , source: EW1 )
  PERFORM update_05. " TABD ZEWMINOUTCTRL ( EN , source: EW1 )
  PERFORM update_06. " TABD ZEWMINOUTCTRL ( JA , source: EW1 )
  PERFORM update_07. " TABT ZEWMINOUTCTRL ( EN , source: EW1 )
